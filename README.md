go-chart
========
[![Build Status](https://travis-ci.org/Graeme22/go-chart.svg?branch=master)](https://travis-ci.org/Graeme22/go-chart)[![Go Report Card](https://goreportcard.com/badge/github.com/Graeme22/go-chart)](https://goreportcard.com/report/github.com/Graeme22/go-chart)
...
```bash
> go get -u github.com/Graeme22/go-chart
```
...
![](https://raw.githubusercontent.com/Graeme22/go-chart/master/_images/tvix_ltm.png)

Single axis:

![](https://raw.githubusercontent.com/Graeme22/go-chart/master/_images/goog_ltm.png)

Two axis:

![](https://raw.githubusercontent.com/Graeme22/go-chart/master/_images/two_axis.png)

# Other Chart Types

Pie Chart:

![](https://raw.githubusercontent.com/Graeme22/go-chart/master/_images/pie_chart.png)

The code for this chart can be found in `_examples/pie_chart/main.go`.

Stacked Bar:

![](https://raw.githubusercontent.com/Graeme22/go-chart/master/_images/stacked_bar.png)
...
import (
    ...
    "bytes"
    ...
    "github.com/Graeme22/go-chart" //exposes "chart"
)
